...
void uart_init(u32 bound){
	...
	GPIO_Init(UART_TX_GPIO_PORT, &GPIO_InitStructure);//初始化GPIOA.9
   
	//USART1_RX	  GPIOA.10初始化
	GPIO_InitStructure.GPIO_Pin = UART_RX_GPIO_PIN;//PA10
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;//浮空输入
	GPIO_Init(UART_RX_GPIO_PORT, &GPIO_InitStructure);//初始化GPIOA.10  
	...
	USART_Init( UART_PORT, &USART_InitStructure );		//初始化外设
